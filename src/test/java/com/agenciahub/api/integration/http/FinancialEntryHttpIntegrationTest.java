...
class FinancialEntryHttpIntegrationTest extends AbstractIntegrationTest {

    @Test
    void list_withoutAuth_returns401() throws Exception {
        mockMvc.perform(get(IntegrationHttpSupport.API_PREFIX + "/financial-entries"))
    ...
    void get_whenMissing_returns404() throws Exception {
        mockMvc.perform(http.authorized(
                        mockMvc,
                        get(IntegrationHttpSupport.API_PREFIX + "/financial-entries/" + UUID.randomUUID())))
    ...
    void create_invalidBody_returns400() throws Exception {
        mockMvc.perform(http.authorized(
                        mockMvc,
                        post(IntegrationHttpSupport.API_PREFIX + "/financial-entries")
    ...
    void patch_whenMissing_returns404() throws Exception {
        mockMvc.perform(http.authorized(
                        mockMvc,
                        patch(IntegrationHttpSupport.API_PREFIX + "/financial-entries/" + UUID.randomUUID())
                                .contentType(MediaType.APPLICATION_JSON)
