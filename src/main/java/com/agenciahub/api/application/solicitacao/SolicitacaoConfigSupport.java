...
final class SolicitacaoConfigSupport {

    private SolicitacaoConfigSupport() {}

    static ArrayNode emptyArray(ObjectMapper objectMapper) {
        return objectMapper.createArrayNode();
    }

    static JsonNode defaultLinks(ObjectMapper objectMapper) {
        try {
            String json =
                    """
                    [
    ...
    static SolicitacaoConfigResponse toResponse(SolicitacaoConfig config) {
    ...
    static SolicitacaoConfigResponse withAgencyLogoFallback(SolicitacaoConfigResponse response, Agency agency) {
    ...
    static SolicitacaoConfigResponse defaultResponse(String slug, ObjectMapper objectMapper) {
        return new SolicitacaoConfigResponse(
                slug,
    ...
    static SolicitacaoConfig newDefaultForAgency(Agency agency, ObjectMapper objectMapper) {
