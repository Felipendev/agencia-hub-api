...
public interface CustomerAPI {
    ...
    List<CustomerSummaryResponseDTO> list(
    ...
    ResponseEntity<CustomerSummaryResponseDTO> lookup(
    ...
    CustomerSummaryResponseDTO get(@Parameter(description = "id do cliente") @PathVariable UUID id);

    @PostMapping
    @ResponseStatus(HttpStatus.CREATED)
    @Operation(summary = "Cria cliente")
    CustomerSummaryResponseDTO create(@Valid @RequestBody CreateCustomerRequestDTO request);

    @PatchMapping("/{id}")
    @Operation(summary = "Atualiza parcialmente o cliente")
    CustomerSummaryResponseDTO patch(
